//este codigo realiza una busqueda de un grafo ponderado utilizando el algoritmo
//dijkstra y encuentra el camino mas corto entre 2 puntos en un grafo no dirigido
let plane = 0;
let p1=-1, p2=-1;
